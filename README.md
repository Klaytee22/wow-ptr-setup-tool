...
tests/                        149 tests, no game install and no Pester required
```
...
```powershell
./tests/Invoke-Tests.ps1                       # all 149
...
v0.3 — 149 passing tests, including an end-to-end pass over a realistic mock install.
