...
tests/                        152 tests, no game install and no Pester required
```
...
```powershell
./tests/Invoke-Tests.ps1                       # all 152
...
v0.3 — 152 passing tests, including an end-to-end pass over a realistic mock install.
