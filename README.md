...
tests/                        172 tests, no game install and no Pester required
```
...
```powershell
./tests/Invoke-Tests.ps1                       # all 172
...
v0.3 — 172 passing tests, including an end-to-end pass over a realistic mock install.
